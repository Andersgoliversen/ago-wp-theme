...
<form role="search" method="get" class="w-full max-w-md mx-auto flex flex-row items-stretch" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <input type="search" id="search-field" name="s" class="flex-grow border border-neutral-300 dark:border-neutral-700 rounded-l px-3 py-2 bg-white dark:bg-neutral-800 dark:text-neutral-100" placeholder="<?php esc_attr_e( 'Search...', 'andersgoliversen' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" />
    ...
    <p id="search-warning" class="hidden mt-2 text-neutral-800 dark:text-neutral-100 bg-white dark:bg-neutral-700 px-2 py-1 rounded shadow"><?php esc_html_e( 'Please fill out this field.', 'andersgoliversen' ); ?></p>
</form>
