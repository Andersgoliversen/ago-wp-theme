...
<form role="search" method="get" class="w-full max-w-md mx-auto flex flex-row items-stretch" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <input type="search" id="search-field" name="s" class="flex-grow border border-neutral-300 dark:border-neutral-700 rounded-l px-3 py-2 bg-white dark:bg-neutral-800 dark:text-neutral-100" placeholder="<?php esc_attr_e( 'Search …', 'andersgoliversen' ); ?>" value="<?php echo get_search_query(); ?>" />
