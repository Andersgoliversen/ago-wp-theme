<footer class="max-w-7xl mx-auto py-8 px-4 text-sm text-gray-500 text-center">
    <nav class="mb-4 flex justify-center space-x-4">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"
           class="no-underline text-inherit decoration-transparent transition-transform duration-150 hover:scale-105 hover:text-neutral-600 active:scale-95 active:text-neutral-900"><!-- Click feedback -->
            <?php bloginfo( 'name' ); ?>
        </a>
