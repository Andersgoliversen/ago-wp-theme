...
<header id="masthead"
                ...
                <div class="max-w-7xl mx-auto flex flex-col items-center gap-4 px-6 py-4 md:flex-row md:justify-center">
                        ...
                        <?php
                        /* ----------  Site logo and title ------------------- */
                        $logo_classes  = 'no-underline text-inherit decoration-transparent transition-transform duration-150 hover:scale-105 hover:opacity-80 active:scale-95 inline-flex items-center'; // Added active state for click feedback
                        // Add larger text size if on front page
                        if (is_front_page()) {
                                $name_classes = 'no-underline text-inherit decoration-transparent transition-transform duration-150 hover:scale-105 hover:opacity-80 active:scale-95 text-xl md:text-2xl font-semibold'; // Add active state
                        } else {
                                $name_classes = 'no-underline text-inherit decoration-transparent transition-transform duration-150 hover:scale-105 hover:opacity-80 active:scale-95 text-xl font-semibold'; // Add active state
                        }
                        ?>
                        <div class="flex items-center gap-2">
                                ...
                                <button class="theme-toggle md:hidden no-underline decoration-transparent ml-2" aria-label="<?php esc_attr_e( 'Toggle color scheme', 'andersgoliversen' ); ?>">
                        ...
                        <nav class="flex flex-wrap gap-4 justify-center" aria-label="<?php esc_attr_e( 'Primary', 'andersgoliversen' ); ?>">
                                <?php if ( has_nav_menu( 'primary' ) ) : ?>
                                        ...
                                        ?>
                                <?php else : ?>
                                        <?php ag_render_fallback_nav_links(); ?>
                                <?php endif; ?>
                        </nav>
                        <!-- ----------  GitHub icon link ---------------------------- -->
                        <a href="https://github.com/Andersgoliversen" target="_blank" rel="noopener"
                                ...
                                aria-label="<?php esc_attr_e( 'GitHub profile', 'andersgoliversen' ); ?>"><!-- Darken and shrink on click -->
                        ...
                        <a href="https://www.youtube.com/@andersgoliversen" target="_blank" rel="noopener"
                                ...
                                aria-label="<?php esc_attr_e( 'YouTube channel', 'andersgoliversen' ); ?>"><!-- Darken and shrink on click -->
                        ...
                        <button class="theme-toggle hidden md:inline-flex no-underline decoration-transparent ml-2" aria-label="<?php esc_attr_e( 'Toggle color scheme', 'andersgoliversen' ); ?>">
                                <svg class="sun w-5 h-5 transition-transform duration-150 hover:scale-105 active:scale-95" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="5"/>
                                        <g>
                                                <line x1="12" y1="1" x2="12" y2="3"/>
