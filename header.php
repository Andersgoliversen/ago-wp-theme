        ...
        <header id="masthead"
                ...
                <div class="max-w-7xl mx-auto flex items-center justify-center gap-4 px-6 py-4">
                        ...
                        <a href="https://github.com/Andersgoliversen" target="_blank" rel="noopener"
                                class="no-underline text-inherit decoration-transparent transition-transform duration-150 hover:scale-105 hover:text-neutral-600 ag-interactive"
                        ...
                        <a href="https://www.youtube.com/@andersgoliversen" target="_blank" rel="noopener"
                                class="no-underline decoration-transparent transition-transform duration-150 hover:scale-105 group header-youtube-link ag-interactive"
